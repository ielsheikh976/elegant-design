...
function Contact() {
    ...
    const handleWhatsApp = () => {
        const phoneNumber = "201009067128";
        ...
        <>
                ...
                <div className="w-full lg:w-1/2 mt-20">
                    <div className="grid grid-cols-1 md:grid-cols-2  gap-5">
                        ...
                        <div>
                            ...
                            <span onClick={() => window.location.href = 'tel:+201009067128'}
                                  className="text-(--prim) font-semibold hover:cursor-pointer">
                                    <i className="bi bi-telephone-inbound text-md pr-3 py-2 rounded-full"/> 01009067128
                            </span>
                        ...
                        <div className="lg:w-1/2 w-full">
                            ...
                            <div className="mt-5">
                                <button onClick={handleWhatsApp}
                                        className="px-5 py-3 bg-white border border-gray-300 rounded-lg GolosText font-semibold
            ...
            <div className="contact-map h-[600px]">
                <iframe className="w-full rounded-2xl brightness-100 grayscale"
                        src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d225.3860005220825!2d30.64391342799552!3d31.13259221216103!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2seg!4v1765546763621!5m2!1sen!2seg"
